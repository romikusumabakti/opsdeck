...
// Streams the global running-runs list as SSE. Same pattern as the per-run
    ...
    async start(controller) {
      ...
      try {
        ...
        while (!aborted) {
          ...
          let runs: Awaited<ReturnType<typeof getActiveRuns>>;
          try {
            runs = await getActiveRuns();
          } catch (err) {
